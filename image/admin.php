...
<body>
    ...
    <form class="form hi" method="POST" action="#" enctype="multipart/form-data">
        ...
        <label for="image" class=" im add flex-c-m stext-101 cl0 size-103 bg1 bor1 hov-btn2 p-lr-15 trans-04"><input
                id="image" class="form-control form-control-lg" type="file" name="product-image" Required>choose
            file</label>
    ...
    <div>
        ...
        if ($_SESSION["status"] == true) {
            ...
            if ($_SESSION["cards"] != null) {
                ...
                echo "<h2 class='no'>no pruduct to show</h2>";
            }
        } else {
